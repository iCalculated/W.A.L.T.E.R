  ...
  labelExpressionInfo: {
    expression: "$feature.CURRENT_VOLUME"
  }
};
          ...
          var pureData = new FeatureLayer({
              url: "https://services9.arcgis.com/8rpYigBN8u7MRe2y/arcgis/rest/services/one_year/FeatureServer",
              opacity: .5
          });

          map.add(pureData);

          var aadt = new FeatureLayer({
              url: "https://services9.arcgis.com/8rpYigBN8u7MRe2y/arcgis/rest/services/trans_annual_average_daily_traffic_segmentsgdb/FeatureServer",
          ...
          //   var wellsQuery = aadt.createQuery();
          //   return aadt.queryFeatures(wellsQuery).then(function(response) {
          ...
          // console.log(queryForWellGeometries());
          ...
          var routeTask = new RouteTask({
              url: "https://utility.arcgis.com/usrsvcs/appservices/LheTqNfEcDSpsMzO/rest/services/World/Route/NAServer/Route_World"
          });
